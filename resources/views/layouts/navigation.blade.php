            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/medibook-logo.png') }}" alt="MediBook Logo" class="h-20 w-auto">   
                     </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                        <span class="font-semibold text-lg">MediBook</span>
                    </x-nav-link>
                </div>
            </div>

            <!-- Settings Dropdown (Only show when user is logged in) -->
            @auth
